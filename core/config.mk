...
ifneq ($(EUNOIA_BUILD),)
include vendor/os/config/BoardConfigEunoia.mk
endif
...
ifneq ($(EUNOIA_BUILD),)
ifneq ($(wildcard device/eunoia/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/eunoia/sepolicy/common/sepolicy.mk)
endif
endif
